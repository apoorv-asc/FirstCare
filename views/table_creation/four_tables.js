...
app.get('/',function(req,res){
    ...
    db.query(sql1,function(err,result){
        ...
        res.send("CUSTOMERS table has been added");
    });
    ...
    db.query(sql2,function(err,result){
        ...
        res.send("medicines table has been added");
    });
    ...
    db.query(sql3,function(err,result){
        ...
        res.send("COMPANIES table has been added");
    });
    ...
    db.query(sql4,function(err,result){
        ...
        res.send("boutght_medicines table has been added");
    });
})
